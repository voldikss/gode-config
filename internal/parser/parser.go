...
import (
	...
	"github.com/voldikss/gode-config/internal/parser/json"
	"github.com/voldikss/gode-config/internal/parser/yaml"
)
...
var ParserMap = map[string]func(string, string) (map[string]any, error){
	...
	// ".env": func(filepath, content string) (map[string]any, error) {
	// 	return yaml.Parse(filepath, content)
	// },
}
